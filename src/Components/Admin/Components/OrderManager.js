...
function OrderManager() {
    ...
    <div className={styles.container}>
        ...
        <div className={styles.tag_pick_date}>
            ...
            Ngày bắt đầu:
            <input type="date" className={styles.input_pickdate} value={startDate} onChange={(e)=>setStartDate(e.target.value)} placeholder="Ngày bắt đầu"/>
            Ngày kết thúc:
            <input type="date" className={styles.input_pickdate} value={endDate} onChange={(e)=>setEndDate(e.target.value)} placeholder="Ngày kết thúc"/>
        </div>
